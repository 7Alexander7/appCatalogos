modificarTitulo('Productos / Lista de Productos')
...
function traerDatos(origen, estado) {
    try {
        ...
        fetch(ipServidor + 'api/productos/lsProductos', {
            headers: {
    ...
    fetch(ipServidor + 'api/subirImagen', {
        ...
        .then(json => {
            if (json.success == true) {
                ...
                notificaciones("PRODUCTOS", "se ha guardado la imagen exitosamente, RECUERDE guardar para finalizar", "bien")
            } else {
...
function guardar(e) {
    ...
    fetch(ipServidor + 'api/productos/actProducto', {
        headers: {
            'Content-type': 'application/json'
        },
        method: 'POST',
